...
void initButtons() {
  ...
  btn7.initButtonUL(80, 120, BUTTON_W2, BUTTON_H2, TFT_WHITE, TFT_BLACK, TFT_CYAN, "Repeat", 2);
  btn7.setPressAction(btn7_pressAction);
  btn7.setReleaseAction(btn7_releaseAction);

  btn8.initButtonUL(200, 120, BUTTON_W2, BUTTON_H2, TFT_WHITE, TFT_BLACK, TFT_VIOLET, "Question", 2);
